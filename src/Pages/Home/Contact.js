    ...
    return (
        <div
            ...
            <form className='grid'>
                ...
                <input className='w-80  lg:w-96 md:w-96 md:mx-auto lg:mx-auto mb-4 py-2 px-2 rounded' type="text" name='subject' placeholder='Subject' />
                <textarea className='w-80   lg:w-96 md:w-96 md:mx-auto lg:mx-auto mb-4 py-2 h-40 px-2 rounded' placeholder='Your message'></textarea>
